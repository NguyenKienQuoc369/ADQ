...
export function OverviewClient() {
  ...
  // Fallback mock projects when API is unavailable
  const mockProjects = [
    { id: 'p1', name: 'fin_d_project', url: 'findproject.vercel.app', lastScan: '2 giờ trước', critical: 2, high: 5, medium: 12, status: 'risk' },
    { id: 'p2', name: 'thuvianso-truong', url: 'thuvianso-truongcsv...', lastScan: '1 ngày trước', critical: 0, high: 0, medium: 3, status: 'ok' },
    { id: 'p3', name: 'project-mhs-smvh', url: 'project-mhs-smvh.vercel.app', lastScan: 'Đang tiến hành', critical: 1, high: 1, medium: 1, status: 'running' },
    { id: 'p4', name: 'my_film', url: 'my-film-corner.vercel.app', lastScan: '5 ngày trước', critical: 1, high: 2, medium: 0, status: 'stale' },
  ];
  ...
  const projectList = loading ? [] : (projects && projects.length ? projects : (scans.length ? scans : mockProjects));

          ...
          {user ? (
            ...
            <>
              <Link href="/register" className="hidden sm:block">
                <Button variant="ghost" size="sm" className="border border-cyan-500/30 text-cyan-100 hover:bg-cyan-500/10">
                  Tạo tài khoản
                </Button>
              </Link>
              <Link href="/login">
                <Button
                  size="sm"
                  className="border border-cyan-300/60 bg-gradient-to-r from-cyan-300 via-cyan-400 to-sky-400 text-slate-950 shadow-[0_12px_28px_rgba(34,211,238,0.32)] hover:shadow-[0_16px_32px_rgba(34,211,238,0.42)]"
                >

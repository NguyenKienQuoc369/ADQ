...
def build_result_json_tree(target, folder, counts, highlights, output_path, logic_results=None, action_advice=None):
    logic_results = logic_results or {}
    action_advice = action_advice or []
...
def main():
    ...
    build_result_json_tree(
        target, folder, counts, highlights, result_json_path, 
